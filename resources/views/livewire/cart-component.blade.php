                        ...
                        <div class="table-responsive">
                            @if (Session::has('succes_message'))
                                <div class="alert alert-success">
                                    <strong>Succes | {{ Session::get('succes_message') }}</strong>
                                </div>
                            @endif
                                ...
                                <table class="table shopping-summery text-center clean">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach (Cart::instance('cart')->content() as $item)
                                            <tr>
                                                <td class="image product-thumbnail"><img
                                                        src="{{ asset('assets/imgs/products')}}/{{$item ->model-> image}}" alt="{{$item->model ->name }}"
                                                        alt="#"></td>
                                                ...
                                                <td class="action" data-title="Remove">
                                                    <a href="#" class="text-muted"><i class="fi-rs-trash"
                                        ...
                                        <td colspan="6" class="text-end">
                                            <a href="#" class="text-muted" wire:click.prevent="removeAll()"> <i class="fi-rs-cross-small"></i> Clear Cart</a>
                                        </td>
                                        </tr>
                                    </tbody>
                                </table>
