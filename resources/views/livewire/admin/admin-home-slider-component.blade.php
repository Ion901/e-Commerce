                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{route('admin.home.slide.add')}}" class="btn btn-succes float-end">Add New Slide</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($slides as $slide)
                                            <tr>
                                                <td>{{$slide -> id}}</td>
                                                <td><img src="{{asset('assets/imgs/slider')}}/{{$slide -> image}}" alt="no image" width="80"></td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" onclick="deleteConfirmation({{$slide->id}})" class="text-danger">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
            ...
            <div class="modal-body pb-30 pt-30">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h4 class="pb-3">Do you want to delete thiss record?</h4>
