                            ...
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent='updateSlide'>
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter slide title name" wire:model="top_title">
                                        @error('top_title')
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        @if ($newimage)
                                            <img src="{{$newimage->temporaryUrl()}}" alt="no image" width="100"/>
                                            @else
                                            <img src="{{'assets/imgs/slider'}}/{{$image}}" alt="no image" width="100"/>
                                        @endif
                                        @error('image')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
